...
public class ProducerAppWithCallback {
    ...
    private  static final Logger LOG=LoggerFactory.getLogger(ProducerAppWithCallback.class.getName());
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            producer.send(rec,(recordMetadata, e) -> {
                if(e == null)
                    LOG.info("{" + recordMetadata.topic() + "," + recordMetadata.partition()+ "," +recordMetadata.offset()+ "," + recordMetadata.timestamp() + "}");
                else{
