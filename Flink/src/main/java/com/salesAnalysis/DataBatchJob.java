...
import com.salesAnalysis.entities.OrderItem;
import com.salesAnalysis.entities.Product;
...
public class DataBatchJob {
    public static void main(String[] args) throws Exception {
        ...
        DataSource<OrderItem> orderItems = env
                .readCsvFile(DataBatchJob.class.getClassLoader().getResource("Datasets/order_items.csv").getPath())
        ...
        DataSource<Product> products = env
                .readCsvFile(DataBatchJob.class.getClassLoader().getResource("Datasets/products.csv").getPath())
