...
public class ApiGraphDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet<Edge<String, NullValue>> edges = friends
		...
		Graph<String, NullValue, Double> weightedfriendsGraph = friendsGraphs
				.mapEdges(new MapFunction<Edge<String, NullValue>, Double>() {
		...
		SingleSourceShortestPaths<String, NullValue> s1 = new SingleSourceShortestPaths<String, NullValue>(user1Name,
				10);
