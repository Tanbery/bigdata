...
def first_function_execute(**context):
    print("### Begin - First Function Execute ###") 
    print("Hello World  ")
    context['ti'].xcom_push(key= 'mykey', value = "First function says hello")
    print("### End - First Function Execute ###")
    


def second_function_execute(**context):
    print("### Begin - Second Function Execute ###") 
    ...
    print("### End - Second Function Execute ###")
